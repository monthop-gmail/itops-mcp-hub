...
`,
  ...
  writeFileSync(
    join(docs, "งบประมาณ-2570", "กระทรวงมหาดไทย", "ตัวอย่าง-สระลอย.md"),
    `# ตัวอย่างข้อความที่ pdftotext แยกสระลอย (fixture)

ไม่ใช่ไฟล์จากคลังจริง — ใช้ทดสอบว่าค้นชื่อถูกต้องแล้วยังเจอรูปที่สระหลุด

จังหวัดประจวบคีรขี นั ธ์
หมวดครุภณั ฑ์ คอมพิวเตอร์
`,
    "utf8",
  );
  return docs;
